...
export const projects: ProjectCardProps[] = [
  {
    ...
    technologies: ["Next.js", "Prisma", "PostgreSQL", "HeroUI"],
  ...
  },
  {
    ...
    image: "/projects/oscars/winner.png",
  ...
  },
  {
    ...
    technologies: ["Next.js", "Tailwind CSS", "Shadcn UI", "Motion"],
    liveUrl: "https://dangledmystats.net",
    githubUrl: "https://github.com/logstown/dangled-my-stats",
  },
  {
    title: "Lets Overlapp",
    description: "Find a day to meet up with friends! Users can share schedules and find a day to overlap.",
    image: "/projects/lets-overlapp/letsoverlapp.png",
    technologies: ["Next.js", "Tailwind CSS", "DaisyUI", "Convex", "Resend"],
    liveUrl: "https://letsoverl.app",
  },
  {
    title: "FlickSort",
    description: "Rank movies and TV shows by choosing one or the other.",
    image: "/projects/flicksort/flicksort.png",
    technologies: ["Vite", "HeroUI", "Tailwind CSS", "React", "Convex", "Clerk"],
    liveUrl: "https://flicksort.com",
  },
];
